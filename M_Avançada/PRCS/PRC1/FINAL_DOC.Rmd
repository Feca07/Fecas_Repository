...
A la taula \ref{tab:taula}\footnote{Annex \ref{anx:taula}} es comparen casos (X=1) i controls (X=0). En primer lloc, els dos grups són comparables en variables basals clau, ja que no s’observen difererencies entre edat i sexe. 

Per verificar també les dades quant al servei d'alta, tenim que els casos provenen gairebé exclusivament de Traumatologia, mentre que els controls s’agrupen principalment en altres serveis, per tant 
...
Aquest estudi es defineix com un estudi observacional, analític de casos i controls de base hospitalaria i retrospectiu, pensem que aquest disseny és el més adequat per investigar sobre l'associació entre l'expossició a medicaments i la fractura per fragilitat, ja que és eficient en temps i costs.
